          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex gap-3">
                 ...
                 <span>অস্থায়ী ঠিকানা: এম কে টাওয়ার (৫ম তলা), ১২ প্রগতি স্মরনি, ব্লক-জে, বারিধারা, ঢাকা।</span>
              </div>
              <div className="flex gap-3">
                 <svg className="size-5 text-secondary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <div className="space-y-1">
                   <p><span className="font-bold">আহবাহক:</span> মোঃ খাইরুল ইসলাম (০১৭২৭-৬৯৬৮৬৯)</p>
                   <p><span className="font-bold">সদস্য সচিব:</span> তাহাজ্জত হোসেন হিরু (০১৭১১-৩২১০৫৫)</p>
                 </div>
              </div>
              <div className="flex gap-3">
                 <svg className="size-5 text-secondary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <span>debhata.samity2022@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
